       ...
       {/* Payment modal */}
        <div className="w-[calc(100%-32px)] max-w-[330px] bg-white rounded-xl shadow-xl px-4 py-4">
          ...
          <p className="text-[8px] text-gray-500 text-center mt-1 leading-relaxed">
            Updating your billing situation to ₦5,000/month
          </p>
          ...
          <div className="mt-3 rounded-lg bg-gray-50 px-3 py-2.5">
            <p className="text-[7px] text-gray-400 leading-relaxed">
              No charge is being made today. We&apos;re just
              updating your recurring payment authorization
              so your next invoice reflects the new, lower
              amount.
            </p>
          </div>
